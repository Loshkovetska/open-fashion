...
const isValid = (vs: typeof values) => {
  const properties = Object.entries(vs).filter(([key]) => Object.keys(defaultValues).includes(key))
...
const inputStyle = 'pb-4 border-b border-[#D4D4D4] focus:outline-none hover:outline-none'
</script>
