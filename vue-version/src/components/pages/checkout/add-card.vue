...
const handleChange = (key: keyof typeof cardDetails, rotate?: boolean) => (value: string) => {
...
<template>
  <TabContainer :tabNumber="3" topTitle="Payment method">
    <AddCardView :rotateCard="rotateCard" :cardDetails="cardDetails" />
    <div class="mt-8 max-w-[900px] w-full mx-auto gap-6 flex flex-grow flex-col">
      <InputUi
        :class="cn(inputStyle)"
