...
const { topTitle, tabNumber } = defineProps<TabContainerPropType>()

const { currentTab } = storeToRefs(useOrderStore())
</script>
  ...
  <div
    :class="
      cn(
        ...
        currentTab == tabNumber ? 'translate-x-0 opacity-100' : 'translate-x-full opacity-0',
      )
    "
  >
