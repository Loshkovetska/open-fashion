...
<template>
  <TabContainer :tabNumber="0" topTitle="checkout">
    <div className="overflow-auto w-full flex-grow h-full pb-[100px]">
      <OrderList />
      <div
        className="flex items-center gap-2 py-4 px-7 border-b border-t border-[#888888] max-w-[900px] mx-auto"
      >
        <DiscountIcon />
        <InputUi
          className="placeholder:text-[#333333] focus:outline-none flex-grow"
      ...
      <div
        className="flex items-center gap-2 py-4 px-7 border-b border-[#888888] justify-between max-w-[900px] mx-auto"
      >
    ...
    <BottomBar buttonText="Checkout" :onClick="() => orderStore.changeTab(1)" />
  </TabContainer>
</template>
