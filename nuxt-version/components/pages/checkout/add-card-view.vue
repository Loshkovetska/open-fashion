...
import { cn, isMasterCard } from "@/shared/utils";
...
const icon = computed(() =>
  isMasterCard(cardDetails?.cardNumber || "") ? MasterIcon : VisaIcon
);
</script>
<template>
  <div class="max-w-[316px] h-[190px] mx-auto w-full relative">
    ...
    >
      ...
      <div class="flex justify-between flex-col">
        <span class="text-4 text-white mb-2 flex leading-none">
      ...
      <span class="text-lg text-white mb flex">
