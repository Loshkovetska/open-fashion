...
import { useCartStore, useGlobalStore } from "@/shared/stores";
...
<template>
  <Nav
    :open="isMenuOpen"
    :onOpenChange="() => store.changeDialogState('isMenuOpen')"
  />
  <Cart
    :open="isCartOpen"
    :onOpenChange="() => store.changeDialogState('isCartOpen')"
  />
  <Search
    :open="isSearchOpen"
  ...
  <SelectionModal
    :open="!!item"
    :onOpenChange="() => cartStore.changeModalState(null)"
  />
</template>
